...
The 'plugin compile' command allows a developer to compile a singularity plugin 
in the expected environment. The provided host directory is the location of the 
