...
func init() {
	...
	cmdManager.RegisterCmdFlag(&actionAppFlag, actionsCmd...)
	cmdManager.RegisterCmdFlag(&actionBindFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionHomeFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionOverlayFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionScratchFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionWorkdirFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionShellFlag, ShellCmd)
	cmdManager.RegisterCmdFlag(&actionHostnameFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionNetworkFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionNetworkArgsFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionDNSFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionSecurityFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionApplyCgroupsFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionVMRAMFlag, actionsCmd...)
	cmdManager.RegisterCmdFlag(&actionVMCPUFlag, actionsCmd...)
	cmdManager.RegisterCmdFlag(&actionContainLibsFlag, actionsInstanceCmd...)
	...
	cmdManager.RegisterCmdFlag(&actionContainAllFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionNvidiaFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionWritableFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionWritableTmpfsFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionNoHomeFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionNoInitFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionNoHTTPSFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionDockerLoginFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionNoNvidiaFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionVMFlag, actionsCmd...)
	cmdManager.RegisterCmdFlag(&actionVMErrFlag, actionsCmd...)
	cmdManager.RegisterCmdFlag(&actionSyOSFlag, ShellCmd)
	cmdManager.RegisterCmdFlag(&actionPidNamespaceFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionIpcNamespaceFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionNetNamespaceFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionUtsNamespaceFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionUserNamespaceFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionKeepPrivsFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionNoPrivsFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionAddCapsFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionDropCapsFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionAllowSetuidFlag, actionsInstanceCmd...)
	cmdManager.RegisterCmdFlag(&actionPwdFlag, actionsCmd...)
