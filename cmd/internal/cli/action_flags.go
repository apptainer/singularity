...
func init() {
	...
	cmdManager.RegisterCmd(ExecCmd, false)
	cmdManager.RegisterCmd(ShellCmd, false)
	cmdManager.RegisterCmd(RunCmd, false)
	...
	flagManager.RegisterCmdFlag(&actionAppFlag, actionsCmd...)
	flagManager.RegisterCmdFlag(&actionBindFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionHomeFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionOverlayFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionScratchFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionWorkdirFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionShellFlag, ShellCmd)
	flagManager.RegisterCmdFlag(&actionHostnameFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionNetworkFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionNetworkArgsFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionDNSFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionSecurityFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionApplyCgroupsFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionVMRAMFlag, actionsCmd...)
	flagManager.RegisterCmdFlag(&actionVMCPUFlag, actionsCmd...)
	flagManager.RegisterCmdFlag(&actionContainLibsFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionDockerUsernameFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionDockerPasswordFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionTmpDirFlag, actionsCmd...)
	flagManager.RegisterCmdFlag(&actionBootFlag, InstanceStartCmd)
	flagManager.RegisterCmdFlag(&actionFakerootFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionCleanEnvFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionContainFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionContainAllFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionNvidiaFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionWritableFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionWritableTmpfsFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionNoHomeFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionNoInitFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionNoHTTPSFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionDockerLoginFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionNoNvidiaFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionVMFlag, actionsCmd...)
	flagManager.RegisterCmdFlag(&actionVMErrFlag, actionsCmd...)
	flagManager.RegisterCmdFlag(&actionSyOSFlag, ShellCmd)
	flagManager.RegisterCmdFlag(&actionPidNamespaceFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionIpcNamespaceFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionNetNamespaceFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionUtsNamespaceFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionUserNamespaceFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionKeepPrivsFlag, actionsInstanceCmd...)
	flagManager.RegisterCmdFlag(&actionNoPrivsFlag, actionsInstanceCmd...)
