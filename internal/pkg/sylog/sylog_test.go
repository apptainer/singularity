...
func TestPrefix(t *testing.T) {
	...
	// prefix() in the context of Debug mode. This is because in lvlDebug mode
	...
	for _, tt := range tests {
		t.Run("nocolor_"+tt.name, func(t *testing.T) {
			...
			// lvlDebug is special too and does not support disabling color
			if tt.name == "lvlDebug" {
...
func TestWritef(t *testing.T) {
	...
	// corner case
	SetLevel(int(lvlFatal))
	expectedResult := ""
	var buf bytes.Buffer
	writef(&buf, lvlInfo, "%s", str)
	if buf.String() != expectedResult {
