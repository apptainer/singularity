...
func newBuild(defs []types.Definition, conf Config) (*Build, error) {
	...
	case "sif":
		...
		flag, err := ensureGzipComp(b.stages[lastStageIndex].b.TempDir, mksquashfsPath)
		if err != nil {
...
func (b Build) cleanUp() {
	if b.Conf.NoCleanUp {
		...
		for _, s := range b.stages {
			bundlePaths = append(bundlePaths, s.b.RootfsPath, s.b.TempDir)
		}
	...
	for _, s := range b.stages {
		sylog.Debugf("Cleaning up %q and %q", s.b.RootfsPath, s.b.TempDir)
		err := s.b.Remove()
		if err != nil {
