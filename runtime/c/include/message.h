...
void _print(int level, const char *function, const char *file, int line, char *format, ...) __attribute__ ((__format__(printf, 5, 6))); // Flawfinder: ignore

#define print(a,b...) _print(a, __func__, __FILE__, __LINE__, b)
#define pfatal(b...)  _print(ABRT, __func__, __FILE__, __LINE__, b)
