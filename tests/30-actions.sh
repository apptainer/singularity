...
# Testing run command
stest 0 sudo singularity exec --writable "$CONTAINER" sh -c "echo true > /.singularity/runscript"
stest 0 singularity run "$CONTAINER"
stest 0 sudo singularity exec --writable "$CONTAINER" sh -c "echo false > /.singularity/runscript"
stest 1 singularity run "$CONTAINER"


# Testing run command properly hands arguments
stest 0 sudo singularity exec --writable "$CONTAINER" sh -c 'echo echo \"\$@\" > /.singularity/runscript'
