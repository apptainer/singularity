...
test_init "Checking copy functionality"
...
stest 1 singularity exec "$CONTAINER" test -f "/testfile"
stest 1 singularity copy "$CONTAINER" "../examples/busybox/Singularity" "/testfile"
stest 1 singularity exec "$CONTAINER" test -f "/testfile"
stest 0 sudo singularity copy "$CONTAINER" "../examples/busybox/Singularity" "/testfile"
