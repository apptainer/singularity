...
$(config): $(singularity_build_config) $(SOURCEDIR)/etc/conf/gen.go $(SOURCEDIR)/etc/conf/singularity.conf $(SOURCEDIR)/pkg/runtime/engines/singularity/config/config.go
